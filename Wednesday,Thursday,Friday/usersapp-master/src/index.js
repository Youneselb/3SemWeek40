...
const myUrl = "https://hulabulakongen.dk/uge40/api/person/all";
const urlId = "https://hulabulakongen.dk/uge40/api/person/";
...
let options = {
 ...
 fetch("https://hulabulakongen.dk/uge40/api/person/",options);
